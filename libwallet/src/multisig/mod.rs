...
pub use ops::{
	...
	session_apply_raw_with_key, session_apply_with_key, session_create_cross_epoch_raw,
	session_create_multitx_raw, session_create_spend_raw, session_dkg_create_raw,
	session_dkg_export_shares_armored, session_dkg_finalize, session_list,
